    ...
    try {
        ...
        switch (httpMethod) {
            ...
            case 'PUT':
                ...
                const updateResult = await collection.updateOne({ _id: new mongodb_1.ObjectId(_id) }, { $set: updateData });
                response = {
                    statusCode: 200,
                    headers,
            ...
            case 'DELETE':
                ...
                const deleteResult = await collection.deleteOne({ _id: new mongodb_1.ObjectId(deleteId) });
                response = {
                    statusCode: 200,
                    headers,
