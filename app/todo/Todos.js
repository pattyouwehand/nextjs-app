...
const API_URL = 'https://xlz20tg1fd.execute-api.eu-north-1.amazonaws.com/prod/todos'
  ...
  useEffect(() => {
    const fetchTodos = async () => {
      try {
        ...
        setList(data) // Assuming API returns an array of todos
      } catch (error) {
          ...
          list.map((item, index) => (
            ...
            >
              <div className="flex justify-between items-center w-full">
                <div className="block basis-5/6 break-words">{item.value}</div>
